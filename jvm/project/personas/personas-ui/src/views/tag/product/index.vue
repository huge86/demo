...
<script>
import { listProduct, getProduct, delProduct, addProduct, updateProduct, exportProduct } from "@/api/tag/product";
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('是否确认删除产品编号为"' + row.productId + '"的数据项?', "警告", {
