...
CREATE TABLE `biz_in_stock`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '入库单创建时间',
  `modified` datetime NULL DEFAULT NULL COMMENT '入库单修改时间',
...
CREATE TABLE `tb_department`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modified_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `mgr_id` bigint(20) NULL DEFAULT NULL COMMENT '系主任id，关联用户表',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `mgr_id`(`mgr_id`) USING BTREE,
  CONSTRAINT `tb_department_ibfk_1` FOREIGN KEY (`mgr_id`) REFERENCES `tb_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `tb_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1884 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_log` VALUES (1854, 'xiaoge', '导出用户excel', 1030, 'com.coderman.api.system.controller.UserController.export()\n\nresponse:', 'paramName:[response],args:[com.alibaba.druid.support.http.WebStatFilter$StatHttpServletResponseWrapper@21f59cc1]', '127.0.0.1', '2020-08-15 11:45:50', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1855, 'xiaoge', '分配角色', 294, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[6, [Ljava.lang.Long;@2594ddba]', '127.0.0.1', '2020-08-15 11:46:25', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1856, 'xiaoge', '更新菜单', 374, 'com.coderman.api.system.controller.MenuController.update()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, menuVO],args:[234, MenuVO(id=234, parentId=226, menuName=用户添加, url=, icon=el-icon-plus, type=1, orderNum=1, createTime=Tue Mar 10 05:50:44 CST 2020, modifiedTime=Tue Mar 10 07:51:56 CST 2020, disabled=true, open=0, perms=user:add)]', '127.0.0.1', '2020-08-15 11:53:10', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1857, 'xiaoge', '更新菜单', 243, 'com.coderman.api.system.controller.MenuController.update()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, menuVO],args:[234, MenuVO(id=234, parentId=226, menuName=用户添加, url=, icon=el-icon-plus, type=1, orderNum=1, createTime=Tue Mar 10 05:50:44 CST 2020, modifiedTime=Sat Aug 15 11:53:10 CST 2020, disabled=false, open=0, perms=user:add)]', '127.0.0.1', '2020-08-15 11:53:24', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1858, 'xiaoge', '删除用户', 585, 'com.coderman.api.system.controller.UserController.delete()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id],args:[42]', '127.0.0.1', '2020-08-16 23:27:38', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1859, 'xiaoge', '添加用户', 565, 'com.coderman.api.system.controller.UserController.add()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[userVO],args:[UserVO(id=null, username=ange, nickname=niechangan, email=17670753912@qq.com, phoneNumber=17670753912, status=null, createTime=null, sex=1, birth=Sun Aug 16 00:00:00 CST 2020, password=123456, departmentName=null, departmentId=1)]', '127.0.0.1', '2020-08-16 23:28:37', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1860, 'xiaoge', '角色授权', 586, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@730e1017]', '127.0.0.1', '2020-08-16 23:30:18', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1861, 'xiaoge', '分配角色', 189, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[193, [Ljava.lang.Long;@2a1dd4e8]', '127.0.0.1', '2020-08-16 23:30:36', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1862, 'xiaoge', '角色授权', 162, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@5b59c537]', '127.0.0.1', '2020-08-16 23:31:16', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1863, 'xiaoge', '分配角色', 284, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[6, [Ljava.lang.Long;@24d0e4ed]', '127.0.0.1', '2020-08-16 23:31:26', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1864, 'xiaoge', '角色授权', 198, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@36a17377]', '127.0.0.1', '2020-08-16 23:32:23', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1865, 'xiaoge', '导出用户excel', 935, 'com.coderman.api.system.controller.UserController.export()\n\nresponse:', 'paramName:[response],args:[com.alibaba.druid.support.http.WebStatFilter$StatHttpServletResponseWrapper@42de1899]', '127.0.0.1', '2020-08-16 23:52:25', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1866, 'xiaoge', '删除用户', 247, 'com.coderman.api.system.controller.UserController.delete()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id],args:[193]', '127.0.0.1', '2020-08-16 23:55:08', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1867, 'xiaoge', '角色授权', 150, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@2b1fa242]', '127.0.0.1', '2020-08-16 23:55:22', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1868, 'xiaoge', '添加用户', 141, 'com.coderman.api.system.controller.UserController.add()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[userVO],args:[UserVO(id=null, username=ange, nickname=niechangan, email=17670753912@163.com, phoneNumber=17670753912, status=null, createTime=null, sex=1, birth=Sun Aug 16 00:00:00 CST 2020, password=123456, departmentName=null, departmentId=1)]', '127.0.0.1', '2020-08-16 23:55:57', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1869, 'xiaoge', '用户|禁用/启用', 211, 'com.coderman.api.system.controller.UserController.updateStatus()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, status],args:[194, true]', '127.0.0.1', '2020-08-16 23:56:02', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1870, 'xiaoge', '用户|禁用/启用', 131, 'com.coderman.api.system.controller.UserController.updateStatus()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, status],args:[194, false]', '127.0.0.1', '2020-08-16 23:56:03', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1871, 'xiaoge', '分配角色', 130, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[194, [Ljava.lang.Long;@68be2d61]', '127.0.0.1', '2020-08-16 23:56:13', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1872, 'xiaoge', '分配角色', 171, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[194, [Ljava.lang.Long;@3fe10591]', '127.0.0.1', '2020-08-16 23:56:19', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1873, 'xiaoge', '分配角色', 135, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[194, [Ljava.lang.Long;@2e6e354c]', '127.0.0.1', '2020-08-16 23:57:00', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1874, 'ange', '角色授权', 158, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@4035a069]', '127.0.0.1', '2020-08-16 23:57:46', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1875, 'ange', '分配角色', 120, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[194, [Ljava.lang.Long;@160f483d]', '127.0.0.1', '2020-08-16 23:57:57', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1876, 'xiaoge', '删除用户', 310, 'com.coderman.api.system.controller.UserController.delete()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id],args:[194]', '127.0.0.1', '2020-08-18 09:23:35', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1877, 'xiaoge', '添加用户', 238, 'com.coderman.api.system.controller.UserController.add()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[userVO],args:[UserVO(id=null, username=ange, nickname=niechangan, email=1351261434@qq.com, phoneNumber=17670753912, status=null, createTime=null, sex=1, birth=Tue Aug 18 00:00:00 CST 2020, password=123456, departmentName=null, departmentId=1)]', '127.0.0.1', '2020-08-18 09:24:09', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1878, 'xiaoge', '角色授权', 200, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@716e7043]', '127.0.0.1', '2020-08-18 09:30:25', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1879, 'xiaoge', '分配角色', 160, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[195, [Ljava.lang.Long;@7ac3191a]', '127.0.0.1', '2020-08-18 09:30:39', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1880, 'xiaoge', '角色授权', 250, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@770104e9]', '127.0.0.1', '2020-08-18 09:31:56', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1881, 'ange', '导出用户excel', 1430, 'com.coderman.api.system.controller.UserController.export()\n\nresponse:', 'paramName:[response],args:[com.alibaba.druid.support.http.WebStatFilter$StatHttpServletResponseWrapper@4862512a]', '127.0.0.1', '2020-08-18 09:32:19', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1882, 'xiaoge', '角色授权', 333, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[0, [Ljava.lang.Long;@eeb2e17]', '127.0.0.1', '2020-09-22 21:02:03', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1883, 'admin', '角色授权', 464, 'com.coderman.api.system.controller.RoleController.authority()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, mids],args:[126, [Ljava.lang.Long;@314a56e]', '127.0.0.1', '2020-10-20 14:43:04', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (1884, 'admin', '分配角色', 236, 'com.coderman.api.system.controller.UserController.assignRoles()\n\nresponse:{\"code\":200,\"msg\":\"Success\"}', 'paramName:[id, rids],args:[193, [Ljava.lang.Long;@813ffa5]', '127.0.0.1', '2020-10-20 14:43:19', '内网IP|0|0|内网IP|内网IP');
...
CREATE TABLE `tb_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1610 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_login_log` VALUES (1554, 'NieChangan', '2020-08-14 17:17:31', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Unknown', 'Unknown');
INSERT INTO `tb_login_log` VALUES (1555, 'NieChangan', '2020-08-15 11:30:31', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1556, 'zhangyukang', '2020-08-15 11:33:27', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1557, 'xiaoge', '2020-08-15 11:45:24', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1558, 'xiaoge', '2020-08-15 16:59:45', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1559, 'xiaoge', '2020-08-16 23:24:50', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1560, 'ange', '2020-08-16 23:29:15', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1561, 'xiaoge', '2020-08-16 23:29:31', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1562, 'ange', '2020-08-16 23:30:52', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1563, 'xiaoge', '2020-08-16 23:31:07', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1564, 'ange', '2020-08-16 23:31:38', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1565, 'xiaoge', '2020-08-16 23:31:59', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1566, 'ange', '2020-08-16 23:32:35', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1567, 'xiaoge', '2020-08-16 23:33:27', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1568, 'ange', '2020-08-16 23:51:48', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1569, 'xiaoge', '2020-08-16 23:52:15', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1570, 'ange', '2020-08-16 23:56:31', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1571, 'xiaoge', '2020-08-16 23:56:48', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1572, 'ange', '2020-08-16 23:57:10', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1573, 'ange', '2020-08-16 23:58:12', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1574, 'xiaoge', '2020-08-17 00:01:20', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1575, 'xiaoge', '2020-08-18 09:22:48', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1576, 'ange', '2020-08-18 09:28:50', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1577, 'xiaoge', '2020-08-18 09:29:20', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1578, 'ange', '2020-08-18 09:30:55', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1579, 'xiaoge', '2020-08-18 09:31:21', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1580, 'ange', '2020-08-18 09:32:10', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1581, 'xiaoge', '2020-08-20 16:09:14', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Unknown', 'Unknown');
INSERT INTO `tb_login_log` VALUES (1582, 'xiaoge', '2020-08-20 16:11:42', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1583, 'xiaoge', '2020-08-20 16:12:35', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1584, 'xiaoge', '2020-08-20 16:15:12', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1585, 'xiaoge', '2020-08-20 16:15:51', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1586, 'xiaoge', '2020-08-20 18:12:33', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 7');
INSERT INTO `tb_login_log` VALUES (1587, 'xiaoge', '2020-09-04 00:06:27', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1588, 'ange', '2020-09-15 15:06:27', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1589, 'xiaoge', '2020-09-15 15:07:08', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1590, 'xiaoge', '2020-09-22 20:49:02', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1591, 'ange', '2020-09-22 20:50:20', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1592, 'xiaoge', '2020-09-22 20:50:40', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1593, 'xiaoge', '2020-09-22 20:59:34', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1594, 'ange', '2020-09-22 21:00:02', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1595, 'xiaoge', '2020-09-22 21:00:49', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1596, 'ange', '2020-09-22 21:02:15', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1597, 'admin', '2020-10-20 14:41:38', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1598, 'ange', '2020-10-20 14:42:10', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1599, 'admin', '2020-10-20 14:42:26', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1600, 'ange', '2020-10-20 14:43:32', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1601, 'admin', '2020-10-26 10:08:25', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1602, 'xiaoge', '2020-11-02 11:35:01', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1603, 'admin', '2020-11-02 11:35:14', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1604, 'xiaoge', '2020-11-27 09:26:50', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1605, 'xiaoge', '2020-11-27 09:44:34', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1606, 'ange', '2020-11-27 09:49:40', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1607, 'xiaoge', '2020-11-27 09:50:01', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1608, 'xiaoge', '2020-11-27 09:50:36', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1609, 'xiaoge', '2021-01-19 11:38:44', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
INSERT INTO `tb_login_log` VALUES (1610, 'xiaoge', '2021-01-29 13:20:02', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Firefox 8');
...
INSERT INTO `tb_menu` VALUES (234, 226, '用户添加', '', 'user:add', 'el-icon-plus', '1', 1, '2020-03-10 05:50:44', '2020-08-15 11:53:24', 1, 0);
...
CREATE TABLE `tb_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 143 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 210 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (5, 'xiaoge', 'NieChangan', 'Jana@126.com', 'http://thirdqq.qlogo.cn/g?b=oidb&k=icTYjyV5afABvE1v4ge9SLg&s=100&t=1584195695', '17744444444', 1, '2019-06-14 21:12:16', '2020-03-19 04:20:40', 1, 'b546f820-7ca3-4b75-9038-3d4abb5d', 0, 'ec4c46a53d0f9db5a805006bac5aa912', '2020-03-27', 1, 0);
INSERT INTO `tb_user` VALUES (6, 'Georgie', 'zhangyu', 'Georgie@qq.com', 'https://shiro.mrbird.cn:8080/febs/images/avatar/default.jpg', '17766666666', 1, '2019-06-14 21:15:09', '2020-05-18 10:02:42', NULL, NULL, 1, 'dffc683378cdaa015a0ee9554c532225', '2020-03-25', 14, 0);
INSERT INTO `tb_user` VALUES (55, 'coderman', 'zhangyu', 'zhangyukang@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '13426528317', 1, '2020-03-08 10:32:57', '2020-05-06 10:54:51', 1, '00f68ad3-3a85-4323-bcb4-0af41d4c', 1, 'd5fe4ee094895c35c0dc40fbd0befe83', '2020-03-12', 1, 0);
...
INSERT INTO `tb_user` VALUES (67, 'xizhang', 'zhangyu', 'zhangyukang@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '13426528317', 1, '2020-03-08 10:59:33', '2020-03-08 10:59:33', 1, '7fc38a7e-a509-4282-9ae4-6fda9a4c', 1, '3f3f4e9eb26d6a8ed86884776a18a493', '2020-03-24', 16, 0);
INSERT INTO `tb_user` VALUES (69, 'coderman', 'zhangyu', 'zhangyukang@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '13426528317', 1, '2020-03-08 11:02:39', '2020-03-09 03:44:36', 1, 'ded0c6c5-36aa-4c81-a28b-22854d4b', 1, 'a4a36a084752c5edbb404a87cecabb83', '2020-03-22', 1, 0);
INSERT INTO `tb_user` VALUES (71, 'huangjing', 'xiaohuang', '30531614@163.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '15079437282', 1, '2020-03-08 11:08:58', '2020-03-09 05:26:15', 0, 'fb90be8e-c71a-4ee0-81aa-2acc4197', 1, 'ffd25a3b6d3cc7fb0e2b7ae99cd72cfd', '2020-03-06', 1, 0);
INSERT INTO `tb_user` VALUES (72, '章宇康', 'kangs~', 'zhang@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '15079437282', 1, '2020-03-08 11:18:35', '2020-03-09 05:26:08', 0, '7a235999-57c5-488e-85cf-54cb216d', 1, '98ed1a23386f76486fc65a359e32817e', '2020-03-03', 1, 0);
...
INSERT INTO `tb_user` VALUES (76, 'xiaopie', 'nanana', '3051215@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '13426521215', 1, '2020-03-09 01:33:09', '2020-03-09 03:49:32', 1, 'cf94c27b-b752-4d9d-a4a9-d096f166', 1, '2e2a3935ec97359657d82bfb88b3175f', '2020-03-30', 1, 0);
...
INSERT INTO `tb_user` VALUES (126, '480bc4', NULL, 'db6a4@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', NULL, 0, '2020-03-09 02:08:59', '2020-03-09 02:08:59', NULL, '86888065-10a4-4169-b3e9-c894cf5d0e62', 1, '04bf244726d70a67dacf03918f45d768', '2020-03-09', 1, 0);
...
INSERT INTO `tb_user` VALUES (184, 'admin', 'Sys-Test', '3053161401@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '15079454152', 1, '2020-03-21 02:07:32', '2020-05-10 10:32:56', 1, '3d66cd24-01ae-4832-93e3-fea557b2', 1, '$2a$10$XIzfnZEZOZ9CMl9lH6fJQ.Cv13L4BCoeK0SJiJzAk/baebA60Fcky', '2020-03-19', 15, 0);
INSERT INTO `tb_user` VALUES (185, '2222222', '22222222', '22222@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '15079437485', 1, '2020-04-01 11:17:29', '2020-04-01 11:45:25', 1, '9bf3e60a-c643-46d1-9bb8-c200c739', 1, 'd1db198e73e3c81342636dcb832c1fce', '2020-04-27', 14, 0);
INSERT INTO `tb_user` VALUES (186, 'xixxix', 'fdasfsf', '12121515@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '13426525414', 0, '2020-04-11 10:15:26', '2020-04-11 10:15:26', 1, '711eda86-843d-4222-8f8e-6bb72305', 1, '2dc3358e8beb909e8eb208b86d5e5f66', '2020-04-28', 12, 0);
INSERT INTO `tb_user` VALUES (187, '324234', 'fsdfasf', 'fdsafsf@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '15078485741', 1, '2020-04-11 13:41:00', '2020-04-11 13:41:00', 1, '1c62485f-547c-407e-875e-c91029fe', 1, '7b14923f4f75e6af0e247bb9abaaa3b8', '2020-04-15', 12, 0);
INSERT INTO `tb_user` VALUES (188, '1231313', '312313', '31312313@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '15079485858', 1, '2020-05-18 10:05:48', '2020-05-18 10:05:48', 1, '3f1f7870-62b0-4928-9f9b-e706fb7b', 1, '8e1aea821462a1e6dff18e18c137f48d', '2020-05-06', 12, 0);
INSERT INTO `tb_user` VALUES (192, 'NieChangan', 'ange', '1351261434@qq.com', 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif?imageView2/1/w/80/h/80', '17670753912', 1, '2020-07-20 15:04:28', '2020-07-20 15:04:28', 0, 'b546f820-7ca3-4b75-9038-3d4abb5d', 1, 'ec4c46a53d0f9db5a805006bac5aa912', '2020-07-20', 1, 0);
INSERT INTO `tb_user` VALUES (193, 'ange', 'niechangan', '1351261434@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '17670753912', 1, '2020-08-18 09:24:09', '2020-08-18 09:24:09', 1, 'fc638a8d-da35-4fcd-a76a-6afb878a', 1, '$2a$10$X7RC7S75aI6/BAT/BoJjy.Fvtv.KOXxH5bw/ElR/8s564qrsl9fnS', '2020-08-18', 1, 0);
INSERT INTO `tb_user` VALUES (200, 'nca', 'niechangan', '1351261434@qq.com', NULL, '17670753912', 1, '2020-09-26 15:29:00', '2020-09-26 15:29:00', 1, '71a84c9e-cde2-4e51-9621-c2fd9a15', 1, '$2a$10$zK5IgAw36PcXUOj0CnYwuOKwNu2M/Npw0lmN33H3lVsSrvhVG07Ly', '2020-09-09', 1, 0);
INSERT INTO `tb_user` VALUES (201, 'nnn', 'nnnn', '123123', NULL, '123123', 1, '2020-09-26 15:29:57', '2020-09-26 15:29:57', 1, '8d81b3d3-ed22-473f-b9aa-6316b087', 1, '$2a$10$vKkALCrMl4K4TdoswqbLwuNR6o4L.Qn6lIC4bgmcQan0MEpcjZiJC', '2020-09-09', 1, 0);
INSERT INTO `tb_user` VALUES (202, '12313', '123123', '123123', NULL, '123123', 1, '2020-09-26 15:30:33', '2020-09-26 15:30:33', 1, '5b0c1776-4cc3-4a30-8117-9d506ff3', 1, '$2a$10$UhWuGrrUAPiXS8ff64VavumAz2RkHeIt2DNIJbOaBURZoccWOCv/K', '2020-09-29', 1, 0);
INSERT INTO `tb_user` VALUES (203, '123123', '123123', '123123', NULL, '123123', 1, '2020-09-26 15:32:46', '2020-09-26 15:32:46', 1, '7e1d5af4-d10c-4817-96a5-491a4867', 1, '$2a$10$TaDboqE1gX48hojSlTCm7OLn15c8zkxUO3QQJvK9Ne1iLP8Nidrpe', '2020-09-09', 1, 0);
INSERT INTO `tb_user` VALUES (204, '12312345', '123123', '123123', NULL, '123123', 1, '2020-09-26 15:35:27', '2020-09-26 15:35:27', 1, '986b896b-6c02-4687-8fcf-32087c1a', 1, '$2a$10$WBKOgIUA3p9uPp0TEhvHxONpQTdlpfwLyy6hoIO1Ax3eSsQLOjcTS', '2020-09-09', 12, 0);
INSERT INTO `tb_user` VALUES (205, '123123666', '123123', '123123', NULL, '123123', 1, '2020-09-26 15:35:57', '2020-09-26 15:35:57', 1, '135e3e62-9b79-49e7-bd5b-0281e03f', 1, '$2a$10$BvAC7yRrM7BaRdD.f0mrWeI4Bc2XcTnsfQ26zFIIacIZq5c1obd6W', '2020-09-09', 1, 0);
INSERT INTO `tb_user` VALUES (206, 'xiaogeaa', 'xiaogeaa', '123@qq.com', '84f59b9399b64029be286ba84d776c01.png', '17670753912', 1, '2020-10-20 22:54:26', '2020-10-20 22:54:26', 0, '8f29d271-9cba-46bb-ae5f-876a1e86', 1, '$2a$10$lREG5jlczle0K6Ob4KIyVuIeqg1W9McENlYPFi2Wop6u.Fa0xFHOq', '2020-10-20', 1, 0);
INSERT INTO `tb_user` VALUES (208, 'xiaogebb', 'xiaogebb', '123@qq.com', '84f59b9399b64029be286ba84d776c01.png', '17670753912', 1, '2020-10-20 23:07:11', '2020-10-20 23:07:11', 0, '63265a9a-e4bc-4265-87a3-c5c00654', 1, '$2a$10$v7iGblTzNm8DPKlCJQyaXuhCiGZhagiaveU8LnENXnzpf3gbDxO/.', '2020-10-20', 1, 0);
INSERT INTO `tb_user` VALUES (209, 'ange666', 'ange666', '1351261434@qq.com', 'http://xinguan-parent.oss-cn-hangzhou.aliyuncs.com/2020/10/20/87c27d4040e94446a0d091e59bbe4c2f.png', '17670753912', 1, '2020-10-20 23:45:35', '2020-10-20 23:45:35', 1, '13901f9b-d901-440c-b09d-d1ad1be9', 1, '123456', '2020-09-09', 1, 0);
...
INSERT INTO `tb_user_role` VALUES (195, 0);
INSERT INTO `tb_user_role` VALUES (193, 126);
