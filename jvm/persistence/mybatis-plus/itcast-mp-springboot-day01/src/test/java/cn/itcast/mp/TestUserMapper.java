...
public class TestUserMapper {
    ...
    public void testUpdate2() {
        ...
        wrapper.set("age", 21).set("password", "999999") //更新的字段，注意，不是对象属性
...
//查询数据的条数
    ...
    public void testSelectPage(){
        ...
        Page<User> page = new Page<>(2,2); //查询第2页，查询2条数据
    ...
    /**
     * 自定义的方法,验证全局配置中的config-location、mapper-locations是否有效
     */
    @Test
...
//        wrapper.allEq((k, v) -> (k.equals("age") || k.equals("id")) , params);
        ...
        //params前面的lambda是过滤器，如果params里面包含lambda中的字段，则要求匹配
